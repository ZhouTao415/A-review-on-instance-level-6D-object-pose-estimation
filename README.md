...
- [[TUM Semester Thesis](./A_review_on_instance_level_6D_object_pose_estimation.pdf)] A review on instance-level 6D object pose estimation (Note: 1.3/1.0)

- Future research direction: End-to-end Deep Learning-based Method with Refinement
![plot](./DL-based-algorithm.png)
![plot](./figures/Comparisons_RGB_D_each.png)
![plot](./figures/Comparisons_RGB_D.png)
![plot](./figures/Comparisons_RGB_D_plot.png)
